...
def createConsole():
    ...
    console.add_argument("random_state", type = int)
...
if __name__ == "__main__":
    ...
    samples = 300
    x, y = make_blobs(n_samples = samples, n_features=n_features, centers=n_clusters, random_state=1)

    #Mostrando el dataset
    clusters = divideData(x, y, n_clusters, samples, n_features)
    if n_features == 2:
        utilsKmeans.show(clusters)
